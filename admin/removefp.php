...
?>
    ...
    <div id="wrapper">
        ...
        <div class="a-content">
            <div class="atitle">
                <h2>Select Post to un-feature from the Home Page</h2>
            </div>
            <div class="form-wrap">
                <form action="adminAction.php" id="remove-feature" method="POST">
                    <div class="ipanel">
                        <ol>
                            <li>
